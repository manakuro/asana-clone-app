...
// CreateTeammate is the resolver for the createTeammate field.
...
// UpdateTeammate is the resolver for the updateTeammate field.
...
// Teammate is the resolver for the teammate field.
...
func (r *queryResolver) Teammates(ctx context.Context, after *entgql.Cursor[ulid.ID], first *int, before *entgql.Cursor[ulid.ID], last *int, where *ent.TeammateWhereInput) (*ent.TeammateConnection, error) {
...
// TeammateUpdated is the resolver for the teammateUpdated field.
