...
func (*TeammateTask) scanValues(columns []string) ([]any, error) {
...
func (_m *TeammateTask) assignValues(columns []string, values []any) error {
...
// Value returns the ent.Value that was dynamically selected and assigned to the TeammateTask.
// This includes values selected through modifiers, order, etc.
func (_m *TeammateTask) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryTeammate queries the "teammate" edge of the TeammateTask entity.
func (_m *TeammateTask) QueryTeammate() *TeammateQuery {
	return NewTeammateTaskClient(_m.config).QueryTeammate(_m)
}

// QueryTask queries the "task" edge of the TeammateTask entity.
func (_m *TeammateTask) QueryTask() *TaskQuery {
	return NewTeammateTaskClient(_m.config).QueryTask(_m)
}

// QueryTeammateTaskSection queries the "teammateTaskSection" edge of the TeammateTask entity.
func (_m *TeammateTask) QueryTeammateTaskSection() *TeammateTaskSectionQuery {
	return NewTeammateTaskClient(_m.config).QueryTeammateTaskSection(_m)
}

// QueryWorkspace queries the "workspace" edge of the TeammateTask entity.
func (_m *TeammateTask) QueryWorkspace() *WorkspaceQuery {
	return NewTeammateTaskClient(_m.config).QueryWorkspace(_m)
}
...
func (_m *TeammateTask) Update() *TeammateTaskUpdateOne {
	return NewTeammateTaskClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the TeammateTask entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *TeammateTask) Unwrap() *TeammateTask {
...
func (_m *TeammateTask) String() string {
