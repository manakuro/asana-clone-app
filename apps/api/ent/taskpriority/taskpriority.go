...
// OrderOption defines the ordering options for the TaskPriority queries.
...
// ByPriorityType orders the results by the priority_type field.
func ByPriorityType(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPriorityType, opts...).ToFunc()
}
...
func (e PriorityType) MarshalGQL(w io.Writer) {
	io.WriteString(w, strconv.Quote(e.String()))
}

// UnmarshalGQL implements graphql.Unmarshaler interface.
func (e *PriorityType) UnmarshalGQL(val interface{}) error {
	str, ok := val.(string)
	if !ok {
		return fmt.Errorf("enum %T must be a string", val)
	}
	*e = PriorityType(str)
	if err := PriorityTypeValidator(*e); err != nil {
